...
\begin{enumerate}[label=(\alph*)]
	\item
		...
		\end{align}
	\item
		Let Event $E$ := selected card is an ace of spades.\\
		Clearly, \begin{align}
			n(E) &= 1
			\end{align}
		\begin{align}
			\therefore \pr{E} &= \frac{n(E)}{n(S)} 
					  = \frac{1}{52}\\	
			\therefore \pr{E} &= \frac{1}{52}
		\end{align}			
	\item
		\begin{enumerate}[label=\roman*)]
			\item
				Let Event $A$ := selected card is an ace.\\
				...
				\begin{align}
					\therefore \pr{A} &= \frac{n(A)}{n(S)} 
							  = \frac{4}{52}
							  = \frac{1}{13}\\
					\therefore \pr{A} &= \frac{1}{13}
				\end{align}
			\item
				Let Event $B$ := selected card is a black card.\\
				...
				\begin{align}
					\therefore \pr{B} &= \frac{n(B)}{n(S)}
							   = \frac{26}{52}
							   = \frac{1}{2}\\
					\therefore \pr{B} &= \frac{1}{2}
				\end{align}
